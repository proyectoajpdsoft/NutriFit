          ...
          builder: (context, setLocalState) => AlertDialog(
            ...
            title: Row(
              children: [
                ...
                const SizedBox(width: 8),
                const Expanded(child: Text('Verificar email')),
              ],
            ),
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      'Vamos a verificar la cuenta $targetEmail para que puedas recuperar el acceso por correo si olvidas tu contrasena.',
                      style: Theme.of(context).textTheme.bodyMedium,
                    ),
                  ),
                  const SizedBox(height: 12),
                  buildStep(
                    ...
                    text:
                        'Pulsa en "Enviar código" para recibir un código de 10 dígitos en tu email.',
                  ),
                  ...
                  buildStep(
                    ...
                    color: Colors.green.shade700,
                    text:
                        'Escribe el código recibido y pulsa "Validar código" para completar la verificación.',
                  ),
                  ...
                  if (_emailVerified && _emailVerificationDate != null)
                    Padding(
                      ...
                      child: Text(
                        'Email verificado el $_emailVerificationDate',
                        style: const TextStyle(
                          fontSize: 12,
            ...
            actions: [
              ...
              ElevatedButton.icon(
                onPressed: _loadingEmailVerification
                    ? null
                    : () async {
                        await _verifyEmailCode(codeController.text);
                        if (!mounted) return;
                        setLocalState(() {});
                      },
  ...
  Future<void> _establecerConfianzaDispositivoActual() async {
    final goToLogin = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text(
          'Para marcar este dispositivo como de confianza debes validar 2FA en el próximo inicio de sesión activando la casilla "Confiar en este dispositivo".\n\n¿Quieres cerrar sesión ahora?',
        ),
        actions: [
          TextButton(
              ...
              Container(
                ...
                child: Text(
                  _isCurrentDeviceTrusted
                      ? 'Este dispositivo está marcado como de confianza.'
                      : 'Este dispositivo no está marcado como de confianza.',
                ),
              ),
              const SizedBox(height: 12),
              SizedBox(
                ...
                child: _isCurrentDeviceTrusted
                    ? OutlinedButton.icon(
                        ...
                        label:
                            const Text('Quitar confianza en este dispositivo'),
                      )
                    : ElevatedButton.icon(
                        onPressed: (_loadingTwoFactor || _loadingTrustedDevice)
                            ? null
                    ...
                    SingleChildScrollView(
                      ...
                      child: Form(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            // Avatar de perfil + estado 2FA activado
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Expanded(
                            ...
                            Row(
                              children: [
                                ...
                                if (!_emailVerified) const SizedBox(width: 8),
                                if (!_twoFactorEnabled)
                                  Expanded(
                                    child: OutlinedButton.icon(
